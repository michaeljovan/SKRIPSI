                ...
                <div class="card shadow-sm border-0">
                    ...
                    <div class="card-body">
                        ...
                        @php
                            ...
                            $people = [];
                            foreach ($dosenList as $n) {
                                $people[] = ['tipe' => 'dosen', 'nama' => $n];
                            }
                            foreach ($mahasiswaList as $n) {
                                $people[] = ['tipe' => 'mahasiswa', 'nama' => $n];
                            }
                        @endphp
                        ...
                        <form id="form-evaluasi" method="POST"
                            action="{{ route('EvaluasiMitraKinerja.perorangan.store.token', ['token'=>$token])}}"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="pengisi_mitra" class="form-control"
                                    value="{{ old('pengisi_mitra') }}" required>
                            </div>
                                    ...
                                    <div class="accordion-item">
                                        <h2 class="accordion-header" id="heading-{{ $i }}">
                                            <button class="accordion-button {{ $i ? 'collapsed' : '' }}" type="button"
                                                ...
                                                <span
                                                    class="me-2 badge {{ $p['tipe'] == 'dosen' ? 'bg-secondary' : 'bg-info' }}">
                                                    {{ ucfirst($p['tipe']) }}
                                                </span>
                                                {{ $p['nama'] }}
                                            </button>
                                        ...
                                        <div id="collapse-{{ $i }}"
                                            ...
                                            data-bs-parent="#accordionOrang">
                                            <div class="accordion-body">

                                                {{-- hidden fields --}}
                                                <input type="hidden" name="items[{{ $i }}][tipe_responden]"
                                                    value="{{ $p['tipe'] }}">
                                                <input type="hidden" name="items[{{ $i }}][nama_responden]"
                                                    value="{{ $p['nama'] }}">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="file" class="form-control"
                                                        name="items[{{ $i }}][pdfFile]" accept=".pdf">
                                                </div>
